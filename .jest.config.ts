  ...
  projects: [
    {
      ...
      testMatch: ['<rootDir>/packages/ssx-sdk/tests/?(*.)+(spec|test).[jt]s?(x)'],
    },
    {
      displayName: SSXReact.name,
      transform: { '^.+\\.(ts|tsx)?$': 'ts-jest' },
      testMatch: ['<rootDir>/packages/ssx-react/tests/?(*.)+(spec|test).[jt]s?(x)'],
    },
    {
      displayName: SSXServer.name,
      transform: { '^.+\\.(ts|tsx)?$': 'ts-jest' },
      testMatch: ['<rootDir>/packages/ssx-server/tests/?(*.)+(spec|test).[jt]s?(x)'],
    },
    {
      displayName: SSXServerless.name,
      transform: { '^.+\\.(ts|tsx)?$': 'ts-jest' },
      testMatch: ['<rootDir>/packages/ssx-serverless/tests/?(*.)+(spec|test).[jt]s?(x)'],
    },
    {
      displayName: SSXGnosisExtension.name,
      transform: { '^.+\\.(ts|tsx)?$': 'ts-jest' },
      testMatch: ['<rootDir>/packages/ssx-gnosis-extension/tests/?(*.)+(spec|test).[jt]s?(x)'],
    },
  ],
});
