...
import { SSXEnsData, SSXEnsResolveOptions, SSXRPCProvider, SSXServerEndpoints } from '../types';
...
export type SSXProviderServer = {
    host: SSXServerHost;
    /** Optional configuration for the server's endpoints. */
    endpoints?: SSXServerEndpoints;
};
